...
module.exports = function( grunt ) {
	...
	const pluginName = 'oxy-extended';
	const textDomain = 'oxy-extended';
	...
	grunt.initConfig({
		...
		addtextdomain: {
			options: {
				...
				updateDomains: ['powerpack', 'oxygen']  // List of text domains to replace.
			},
			target: {
				files: {
					src: [
		...
		replace: {
			main: {
				...
				replacements: [
					...
					{
						from: /OXY_EXTENDED_VER', '.*?'/g,
						to: 'OXY_EXTENDED_VER\', \'<%= pkg.version %>\''
					},
				]
			},
