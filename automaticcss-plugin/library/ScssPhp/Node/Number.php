...
class Number extends Node implements \ArrayAccess {
	 ...
	 */
	public function __construct( $dimension, $numeratorUnits, array $denominatorUnits = array() ) {
		if ( is_string( $numeratorUnits ) ) {
			$numeratorUnits = $numeratorUnits ? array( $numeratorUnits ) : array();
	 ...
	 * Output number
	 *
	 * @param \ScssPhp\Compiler $compiler
	 *
	 * @return string
	 */
